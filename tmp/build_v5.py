#!/usr/bin/env python3
"""Build v5 image: v4 base + newer netboot.elf (with v5 diagnostics) in
FW_MAIN_A/B, re-signed with devkeys. Output: tmp/gale-netboot-v5.bin

v5 adds: GCC ARES probe + clear, MDIO controller readback liveness check.
"""
...
BASE = f"{ROOT}/tmp/gale-netboot-v4.bin"   # use v4 as base; falls back if missing
STOCK = "/home/tim/local/gwifi/gale-spi-stock-2026-05-28.bin"
OUT  = f"{ROOT}/tmp/gale-netboot-v5.bin"
