...
FW_MAIN_A/B, re-signed with devkeys. Output: tmp/gale-netboot-v6.bin
...
BASE = f"{ROOT}/tmp/gale-netboot-v5.bin"   # use v4 as base; falls back if missing
STOCK = "/home/tim/local/gwifi/gale-spi-stock-2026-05-28.bin"
OUT  = f"{ROOT}/tmp/gale-netboot-v6.bin"
